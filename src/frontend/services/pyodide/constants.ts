export const PYODIDE_CONFIG = {
  ...
  CURRENT_STORAGE_VERSION: "3.0.0", // Removed old simulated streaming endpoints
  API_PATHS: [
    "/persist/api",
    "/persist/api/app",
    "/persist/api/app/api",
    ...
    "/persist/api/app/reactive_sqlmodel",
    "/persist/api/v1",
  ],
  API_FILES: [
    "/__init__.py",
    ...
    "/app/reactive_sqlmodel/__init__.py",
    "/app/reactive_sqlmodel/runtime.py",
    "/app/reactive_sqlmodel/model.py",
    "/app/reactive_sqlmodel/sync_tables.py",
    "/app/reactive_sqlmodel/transport.py",
    "/app/reactive_sqlmodel/mount_server.py",
    "/app/reactive_sqlmodel/mount_client.py",
    "/app/examples/__init__.py",
    "/app/examples/oauth2_example.py",
    "/v1/main.py",
  ],
  MUTATING_METHODS: ["POST", "PUT", "PATCH", "DELETE"],
  REQUIRED_PACKAGES: ["fastapi", "pydantic", "sqlalchemy", "sqlmodel", "typing_extensions"],
} as const;
