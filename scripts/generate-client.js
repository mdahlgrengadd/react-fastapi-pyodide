...
function checkServer() {
  return new Promise((resolve) => {
    const request = http.get(CONFIG.serverCheckUrl, { timeout: 5000 }, (res) => {
...
async function generateClient() {
  ...
  if (!isServerRunning) {
    ...
    log('  python -m uvicorn app.app_main:app --host 0.0.0.0 --port 8000', colors.yellow);
    process.exit(1);
  }
  ...
  log(`📖 Import functions like: import { getUsers, getPosts } from '../client'`, colors.cyan);
}
